...
class Calculate_GROVITAL_Screen extends StatefulWidget {
  const Calculate_GROVITAL_Screen({Key? key}) : super(key: key);

  @override
  _Calculate_GROVITAL_Screen_State createState() =>
      _Calculate_GROVITAL_Screen_State();
}

class _Calculate_GROVITAL_Screen_State
    extends State<Calculate_GROVITAL_Screen> {
  ...
  void _onSelect(String category, String item, bool isSelected) {
    setState(() {
      if (category == "finca") {
        _selectedFinca = isSelected ? item : "GROVITAL";
  ...
  Widget build(BuildContext context) {
    List<String> itemsHesct = GROVITALData.map((data) {
