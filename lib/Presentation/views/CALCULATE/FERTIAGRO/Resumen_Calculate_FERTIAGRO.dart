...
import 'package:azaktilza/Presentation/views/CALCULATE/FERTIAGRO/Edit_Calculate_FERTIAGRO.dart';
...
class Resumen_Calculate_FERTIAGRO extends StatefulWidget {
  const Resumen_Calculate_FERTIAGRO({Key? key}) : super(key: key);

  @override
  _Resumen_Calculate_FERTIAGRO_State createState() =>
      _Resumen_Calculate_FERTIAGRO_State();
}

class _Resumen_Calculate_FERTIAGRO_State
    extends State<Resumen_Calculate_FERTIAGRO> {
  ...
  void initState() {
    ...
    if (kIsWeb) {
      ...
      basePath = dotenv.env['RESULT_ALIMENTATION']!;
    }
                      ...
                      return GestureDetector(
                        onTap: () {
                          Navigator.of(context).push(
                            MaterialPageRoute(
                              builder: (context) =>
                                  Edit_Calculate_FERTIAGRO(id: id),
                            ),
                          );
                        },
                        child: Padding(
      ...
      floatingActionButton: Tooltip(
        ...
        child: FloatingActionButton(
          onPressed: () {
            Navigator.of(context).push(
              MaterialPageRoute(
                builder: (context) => const Calculate_FERTIAGRO_Screen(),
              ),
            );
          },
  ...
  Widget _infoRow(String label, dynamic value) {
    ...
    if (value == null) {
      ...
      // Intenta convertir si es un número en String
