...
class Calculate_FERTIAGRO_Screen extends StatefulWidget {
  const Calculate_FERTIAGRO_Screen({Key? key}) : super(key: key);

  @override
  _Calculate_FERTIAGRO_Screen_State createState() =>
      _Calculate_FERTIAGRO_Screen_State();
}

class _Calculate_FERTIAGRO_Screen_State
    extends State<Calculate_FERTIAGRO_Screen> {
  ...
  void _onSelect(String category, String item, bool isSelected) {
    setState(() {
      if (category == "finca") {
        _selectedFinca = isSelected ? item : "FERTIAGRO";
  ...
  Widget build(BuildContext context) {
    List<String> itemsHesct = FERTIAGROData.map((data) {
