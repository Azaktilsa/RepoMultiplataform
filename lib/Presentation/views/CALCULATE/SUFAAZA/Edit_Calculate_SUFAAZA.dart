...
class Edit_Calculate_SUFAAZA extends StatefulWidget {
  final String id;

  const Edit_Calculate_SUFAAZA({super.key, required this.id});

  @override
  State<Edit_Calculate_SUFAAZA> createState() => _Edit_Calculate_SUFAAZAState();
}

class _Edit_Calculate_SUFAAZAState extends State<Edit_Calculate_SUFAAZA> {
