...
import 'package:azaktilza/Presentation/views/CALCULATE/SUFAAZA/Edit_Calculate_SUFAAZA.dart';
...
class Resumen_Calculate_SUFAAZA extends StatefulWidget {
  const Resumen_Calculate_SUFAAZA({Key? key}) : super(key: key);

  @override
  _Resumen_Calculate_SUFAAZA_State createState() =>
      _Resumen_Calculate_SUFAAZA_State();
}

class _Resumen_Calculate_SUFAAZA_State
    extends State<Resumen_Calculate_SUFAAZA> {
  static final NumberFormat numberFormatter = NumberFormat("#,##0.##", "en_US");

  final String _selectedFinca = 'SUFAAZA';
  late final basePath;
      ...
      floatingActionButton: Tooltip(
        ...
        child: FloatingActionButton(
          onPressed: () {
            Navigator.of(context).push(
              MaterialPageRoute(
                builder: (context) => const Calculate_SUFAAZA_Screen(),
              ),
            );
          },
