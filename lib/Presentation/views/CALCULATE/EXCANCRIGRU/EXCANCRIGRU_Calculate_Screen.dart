...
class Calculate_EXCANCRIGRU_Screen extends StatefulWidget {
  const Calculate_EXCANCRIGRU_Screen({Key? key}) : super(key: key);

  @override
  _Calculate_EXCANCRIGRU_Screen_State createState() =>
      _Calculate_EXCANCRIGRU_Screen_State();
}

class _Calculate_EXCANCRIGRU_Screen_State
    extends State<Calculate_EXCANCRIGRU_Screen> {
  ...
  void _onSelect(String category, String item, bool isSelected) {
    setState(() {
      if (category == "finca") {
        _selectedFinca = isSelected ? item : "EXCANCRIGRU";
  ...
  Widget build(BuildContext context) {
    List<String> itemsHesct = EXCANCRIGRUData.map((data) {
