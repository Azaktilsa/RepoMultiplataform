...
class GRAFICAS_GROVITAL_Screen extends StatefulWidget {
  const GRAFICAS_GROVITAL_Screen({Key? key}) : super(key: key);

  @override
  _GRAFICAS_GROVITAL_ScreenState createState() =>
      _GRAFICAS_GROVITAL_ScreenState();
}

class _GRAFICAS_GROVITAL_ScreenState extends State<GRAFICAS_GROVITAL_Screen> {
  static const String _selectedFinca = 'GROVITAL';
