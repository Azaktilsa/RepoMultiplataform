...
class GRAFICAS_SUFAAZA_Screen extends StatefulWidget {
  const GRAFICAS_SUFAAZA_Screen({Key? key}) : super(key: key);

  @override
  _GRAFICAS_SUFAAZA_ScreenState createState() =>
      _GRAFICAS_SUFAAZA_ScreenState();
}

class _GRAFICAS_SUFAAZA_ScreenState extends State<GRAFICAS_SUFAAZA_Screen> {
  static const String _selectedFinca = 'SUFAAZA';
